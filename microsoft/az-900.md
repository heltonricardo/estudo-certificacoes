...
A Azure tem suporte a diversos Sistemas Gerenciadores de Banco de Dados (SGBD), entre eles o Cosmos DB. Vamos criar um:
...
- `Computação`: proteção quanto a forma de acessar os recursos dentro da Azure, como BastionHost
